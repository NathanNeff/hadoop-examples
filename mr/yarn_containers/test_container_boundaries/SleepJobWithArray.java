...
/* MODIFIED 2011-11-10 to remove the package declaration and setJobName */
 ...
 * some disk space.
 */
public class SleepJobWithArray extends Configured implements Tool,  
  ...
  public void configure(JobConf job) {
    ...
    // Just run this once per Map -- that should be enough
    if (initBigArray) {
            // Yes, I should use log4j :-/
            System.out.println("Requesting array of " + bigArraySize);
            boolean[] foo = new boolean[bigArraySize];
    }
  ...
  public int run(String[] args) throws Exception {
    ...
    if(args.length < 1) {
      System.err.println("SleepJobWithArray [-m numMapper] [-r numReducer]" +
